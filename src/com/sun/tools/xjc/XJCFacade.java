...
public class XJCFacade {
    ...
    public static void main(String[] args) throws Throwable {
        String[] b = {"-d", "./src", /*"-p", "test.gps",*/ "./resources/GPS.xsd", "-debug", "-b", "./resources/binding.xml"};
        //String[] b = {"-d", "./src", "-p", "test.company", "./resources/company.xsd", "-debug", /*"-b", "./resources/company_binding.xml"*/};
